...
public class CloudManager implements Runnable, Cancellable {
	...
	private String videoQueue = XMLReader.getXMLParameter("/home/vm/azureSystemApp/config/config.xml", "cloud.processqueue");
	private String cancelQueue = XMLReader.getXMLParameter("/home/vm/azureSystemApp/config/config.xml", "cloud.cancelqueue");
	
	private int cancelTryout = Integer.parseInt(XMLReader.getXMLParameter("/home/vm/azureSystemApp/config/config.xml", "cloud.cancelTryout"));
	...
	private void processCancelMessage(CloudQueueMessage msg) throws MCASException {
		if (msg != null){
			...
			System.out.println("Missatge null");
		}
	}
