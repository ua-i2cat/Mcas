...
public class TranscoServiceClient {
	...
	public static final String uri = "http://localhost/MCASlite";
	...
	public static void main(String[] args){
		...
		try {
			while (true){
				System.out.println("Choose request [1-4]: ");
	...
	private static String addTransco(WebResource service, BufferedReader br) throws IOException{
	...
	private static String getState(WebResource service, BufferedReader br) throws IOException{
	...
	private static void cancel(WebResource service, BufferedReader br) throws IOException{
